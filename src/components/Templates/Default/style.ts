...
export const globalStylesSky = `
  ...
  *, html { scroll-behavior: smooth; }
  ...
  .font-cairo  { font-family: "Google Sans", sans-serif; }
  .font-tajawal { font-family: "Tajawal", sans-serif; }
  .font-poppins { font-family: "Google Sans", sans-serif; }
  ...
  .animate-modal-in  { animation: modalIn 0.35s ease-out forwards; }
