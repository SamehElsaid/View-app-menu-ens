  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        >
          <div className="relative w-11 h-11 rounded-full bg-linear-to-br from-cyan-100 to-blue-100 flex items-center justify-center shadow-[0_0_20px_rgba(34,211,238,0.3)] overflow-hidden border border-white/20">
            {menuInfo?.logo ? (
              <Image
                src={menuInfo.logo}
                alt={siteName}
