  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          background: `
            radial-gradient(circle at 20% 30%, rgba(124,58,237,0.45), transparent 60%),
            radial-gradient(circle at 80% 70%, rgba(6,182,212,0.38), transparent 60%),
            radial-gradient(circle at 50% 50%, rgba(124,58,237,0.12), transparent 70%),
      ...
      <div className="fixed inset-0 -z-10 pointer-events-none overflow-hidden">
        ...
        <div className="absolute rounded-full blur-[120px] w-[500px] h-[500px] bottom-[5%] -right-[40px] bg-cyan/25 animate-float-blob [animation-delay:-7s]" />
